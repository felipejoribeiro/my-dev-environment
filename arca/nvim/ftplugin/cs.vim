...
set signcolumn=yes                      " Enable column for signs
...
augroup mygroup
  autocmd!
  " Setup formate specified file type(s).
...
" provide custom status line: lightline.vim, vim-airline.
...
"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
nnoremap <leader>R :source $MYVIMRC<CR> :source ~/.config/nvim/ftplugin/cs.vim<CR>

" coc action to peak color 
nmap <leader>c :call CocAction('pickColor')<CR>
